...
const VesselItems: React.FC = () => {
  const [vesselItems] = useState<VesselItem[]>([
    {
      id: 1,
      vesselItem: 'Tea Flask',
      createdAt: '15-Oct-2024',
      createdBy: 'John Doe',
    },
    {
      id: 2,
      vesselItem: 'Water Container',
      createdAt: '15-Oct-2024',
      createdBy: 'John Doe',
    },
  ]);
                ...
                <form className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter vessel item name"
                    />
                  </div>
